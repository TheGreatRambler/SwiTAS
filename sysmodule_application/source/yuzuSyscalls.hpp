...
YUZU_FUNC(input_readtouch)
YUZU_FUNC(input_settouch)
YUZU_FUNC(input_movemouse)
YUZU_FUNC(input_readmouse)
YUZU_FUNC(input_enableoutsideinput)
YUZU_FUNC(input_getkeyraw)
YUZU_FUNC(input_getkeymodifierraw)
YUZU_FUNC(input_getmouseraw)
YUZU_FUNC(input_setkeyraw)
YUZU_FUNC(input_setkeymodifierraw)
YUZU_FUNC(input_setmouseraw)
