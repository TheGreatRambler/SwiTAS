...
ControllerHandler::ControllerHandler(std::shared_ptr<CommunicateWithNetwork> networkImp, uint8_t startingID) {
	...
	yuzu_joypad_setjoypadtype(yuzuInstance, id, PluginDefinitions::ControllerType::JoyDual);
#endif
}
...
#ifdef YUZU
	yuzu_joypad_setjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::LeftX, controllerData.LS_X);
	yuzu_joypad_setjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::LeftY, controllerData.LS_Y);
	yuzu_joypad_setjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::RightX, controllerData.RS_X);
	yuzu_joypad_setjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::RightY, controllerData.RS_Y);
	uint64_t buttons = 0;
	for(auto const& button : btnToHidKeys) {
		if(GET_BIT(controllerData.buttons, (uint8_t)button.first)) {
...
void ControllerHandler::setFrame(uint64_t buttons, int32_t leftX, int32_t leftY, int32_t rightX, int32_t rightY) {
	clearState();
...
#ifdef YUZU
	yuzu_joypad_setjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::LeftX, leftX);
	yuzu_joypad_setjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::LeftY, leftY);
	yuzu_joypad_setjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::RightX, rightX);
	yuzu_joypad_setjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::RightY, rightY);
	yuzu_joypad_set(yuzuInstance, id, buttons);
#endif
...
#ifdef YUZU
	newControllerData->LS_X = yuzu_joypad_readjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::LeftX);
	newControllerData->LS_Y = yuzu_joypad_readjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::LeftY);
	newControllerData->RS_X = yuzu_joypad_readjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::RightX);
	newControllerData->RS_Y = yuzu_joypad_readjoystick(yuzuInstance, id, PluginDefinitions::YuzuJoystickType::RightY);
#endif
...
#ifdef YUZU
	yuzu_joypad_enablejoypad(yuzuInstance, (PluginDefinitions::ControllerNumber)controllerStartingID, false);
#endif
}