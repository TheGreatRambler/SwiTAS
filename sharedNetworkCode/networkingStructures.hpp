...
namespace MemoryDataInfo {
	...
	std::unordered_map<MemoryType, std::string> memoryTypeName{
	...
	std::unordered_map<MemoryState, std::string> memoryStateName{
		{ MemState_Type, "Type" },
	...
	std::unordered_map<MemoryAttribute, std::string> memoryAttributeName{
	...
	std::unordered_map<Permission, std::string> memoryPermissionName{
		{ Perm_None, "None" },
		{ Perm_R, "Read" },
		{ Perm_W, "Write" },
		{ Perm_X, "Execute" },
